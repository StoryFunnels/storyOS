...
const TEAM_DATA = {
  ...
  projects: { nodes: [
    { id: 'proj-1', name: 'Sharing flow', state: 'started', targetDate: '2026-08-01', url: 'https://linear.app/acme/project/sharing' },
  ] },
  issues: { nodes: [
    { id: 'iss-1', identifier: 'ENG-1', title: 'Share dialog loses focus', url: 'https://linear.app/acme/issue/ENG-1', estimate: 3, priority: 2, state: { type: 'started', name: 'In Progress' }, labels: { nodes: [{ name: 'bug' }] }, assignee: { name: 'Dana K' }, parent: null, cycle: { id: 'cyc-1' }, project: { id: 'proj-1' } },
    { id: 'iss-2', identifier: 'ENG-2', title: 'Fix focus trap', url: 'https://linear.app/acme/issue/ENG-2', estimate: null, priority: 0, state: { type: 'triage', name: 'Triage' }, labels: { nodes: [] }, assignee: null, parent: { id: 'iss-1' }, cycle: null, project: null },
    { id: 'iss-3', identifier: 'ENG-3', title: 'Old spike', url: 'https://linear.app/acme/issue/ENG-3', estimate: 1, priority: 4, state: { type: 'canceled', name: 'Canceled' }, labels: { nodes: [{ name: 'spike' }, { name: 'infra' }] }, assignee: null, parent: null, cycle: null, project: null },
  ] },
};
