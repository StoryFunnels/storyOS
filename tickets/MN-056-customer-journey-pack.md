---
id: MN-056
title: Customer Journey Map pack (simplified from your current tools's 9 databases to 3)
status: done
depends_on: [MN-053]
size: S
---

the reference tool'ships 9 databases (Journey, Stage, Action, Emotion, Goal, Opportunity, Pain point, Thought, Touch point). We compress without losing the method:
