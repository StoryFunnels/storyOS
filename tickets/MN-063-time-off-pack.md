...
Fibery `vacations-pro` = 8 databases + computed remaining days + Slack commands. The computation needs rollups (MN-064); Slack is out of scope. The daily value — "who is out, when, is it approved" — needs neither.
