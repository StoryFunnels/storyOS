...
the reference tool `content-calendar`: Calendar moment, Content, Platform. The stealable idea = **Moments** (holidays, launches, awareness days) as records content attaches to.
