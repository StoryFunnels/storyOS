---
id: MN-058
title: Digital Video Production pack
status: todo
depends_on: [MN-053]
size: S
---
...
**Guide:** the pipeline Idea→Published; script lives ON the video (rich text); JCM tip — relate Videos to Clients cross-pack when Client Work is installed (external relation, machinery exists).

## Acceptance criteria
- [ ] Pack + samples + views + guide + cross-pack Clients relation (skip-note when absent)
