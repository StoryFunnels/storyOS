...
TypeScript monorepo (pnpm + Turborepo) · NestJS 11 API (Fastify) · Next.js 16 web · PostgreSQL (only datastore) · Drizzle ORM · better-auth · BlockNote editor · shadcn/ui + Tailwind · zod everywhere · OpenAPI 3.1 generated from code.
